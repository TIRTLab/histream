...
ivec3 getVoxelIdSemi(vec3 position,vec3 semiRange, float scale,vec3 direction, out ivec3 alignVoxelId)
{
    ...
    // int xf = int(floor((position.x+semiRange.x+direction.x*minTemp*scale)/scale));
    // int yf = int(floor((position.y+direction.y*minTemp*scale)/scale));
    // int zf = int(floor((position.z+semiRange.z+direction.z*minTemp*scale)/scale)); 
    // int xb = int(ceil((position.x+semiRange.x-direction.x*minTemp *scale)/scale));
    // int yb = int(ceil((position.y-direction.y*minTemp*scale)/scale));
    // int zb = int(ceil((position.z+semiRange.z-direction.z*minTemp*scale)/scale)); 
    ...
    int xb = int(ceil((position.x+semiRange.x-direction.x*minTemp)));
    int yb = int(ceil((position.y-direction.y*minTemp)));
    int zb = int(ceil((position.z+semiRange.z-direction.z*minTemp))); 
...
// scaled world, nanoVDB world
ivec3 getVoxelIdSemi(vec3 position,ivec3 semiRange,vec3 direction, out ivec3 alignVoxelId)
{
    float minTemp = 0.05;
    ...
    // int xf = int(ceil((position.x+semiRange.x+direction.x*minTemp*scale)/scale));
    // int yf = int(ceil((position.y+direction.y*minTemp*scale)/scale));
    // int zf = int(ceil((position.z+semiRange.z+direction.z*minTemp*scale)/scale)); 


    // int xb = int(floor((position.x+semiRange.x-direction.x*minTemp *scale)/scale));
    // int yb = int(floor((position.y-direction.y*minTemp*scale)/scale));
    // int zb = int(floor((position.z+semiRange.z-direction.z*minTemp*scale)/scale)); 
