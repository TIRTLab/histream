...
bool Descriptor::createDescriptor(std::shared_ptr<VoxelebIO> &modelio){
 ...
 //   auto & sceneio = modelio->m_sceneio;
    ...
    bindings.addBinding(VoxellstbindingInd::lad, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1, flags);
    ...
    updates.emplace_back(bindings.makeWrite(m_descSet, VoxellstbindingInd::lad, &dbiLad));
