...
void XmlExamples::createVoxelebxml(){
    ...
    m_pVoxelebXml->scenexml.background.sceneSize={6000, 6000, 50}; // length, width, height
...
/*    m_pVoxelebXml->scenexml.background.sMin={0,0,0};
    ...
    m_pVoxelebXml->scenexml.background.stepsize_surface=10;
    m_pVoxelebXml->scenexml.background.stepsize_height=10;
//    m_pVoxelebXml->scenexml.stepsize_atmosphere = 1000;
    ...
    primEntity1= PrimEntity{"building",{"wall","roof"},{"wall","roof"},{"K300","K300"},
                           ...
                           "F:\\work\\field_aoyunlst\\field_data\\aoyun\\aoyun_1m_r.tif"};
    ...
    m_pVoxelebXml->scenexml.primEntities = {primEntity1, primEntity2};
