...
ShadeState GetShadeState(in PtPayload hstate)
{
  ...
  Indices  indices  = Indices(instanceLinks[instanceId].indexAddress);
  Vertices vertices = Vertices(instanceLinks[instanceId].vertexAddress);
  ...
  sstate.typeId         = instanceLinks[instanceId].type; 
